...
- The Anbox Management Service (AMS) API documentation created using OpenAPI specification (Swagger 2.0) is available on the AMS host at `/1.0/swagger.json` and at [AMS API reference](/reference/api-reference/ams-api.md).<!--AC-1474-->
