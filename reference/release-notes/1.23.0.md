...
The documentation source is hosted at the public [Anbox Cloud documentation repository on GitHub](https://github.com/canonical/anbox-cloud-docs). We welcome all contributions to the Anbox Cloud documentation using this repository. See {ref}`Contribute to Anbox Cloud documentation <contribute>` for more information.
...
See {ref}`Upgrade Anbox Cloud <howto-upgrade-anbox-cloud>` or {ref}`Upgrade the Anbox Cloud Appliance <howto-upgrade-appliance>` for instructions on how to update your Anbox Cloud deployment to the 1.23.0 release.
