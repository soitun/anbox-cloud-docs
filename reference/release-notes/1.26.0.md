...
Anbox Cloud 1.26.0 is a minor release. To understand minor and patch releases, see {ref}`Release notes <ref-release-notes>`.
...
- The Anbox log level can be changed at runtime using the {ref}`Anbox HTTP API <anbox-https-api>`. This is helpful in situations when you want to avoid a restart of the Anbox runtime.<!--AC-3183-->
...
See {ref}`How to upgrade Anbox Cloud <howto-upgrade-anbox-cloud>` for instructions on how to update your Anbox Cloud deployment to the 1.26.0 release.
