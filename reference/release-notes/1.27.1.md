...
Anbox Cloud 1.27.1 is a patch release. To understand minor and patch releases, see {ref}`Release notes <ref-release-notes>`.
...
- [LP 2119036](https://bugs.launchpad.net/anbox-cloud/+bug/2119036) The [Anbox Stream Gateway API for ADB shares GET call](/reference/api-reference/gateway-api.md#/share/handle-get-shares) is incorrect.
...
See {ref}`How to upgrade Anbox Cloud <howto-upgrade-anbox-cloud>` for instructions on how to update your Anbox Cloud deployment to the 1.27.1 release.
