...
- The [`prepare-node-script`](/reference/cmd-ref/appliance/anbox-cloud-appliance_prepare-node-script.md) command is extended to support systems with an already installed NVIDIA driver. <!--AC-2714-->
