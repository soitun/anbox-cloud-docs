...
Anbox Cloud 1.27.2 is a patch release. To understand minor and patch releases, see {ref}`Release notes <ref-release-notes>`.
...
See {ref}`How to upgrade Anbox Cloud <howto-upgrade-anbox-cloud>` for instructions on how to update your Anbox Cloud deployment to the 1.27.2 release.
