...
Anbox Cloud 1.24.1 is a patch release. To understand minor and patch releases, see {ref}`Release notes <ref-release-notes>`.
...
- The [`anbox-cloud-appliance buginfo`](/reference/cmd-ref/appliance/anbox-cloud-appliance_buginfo.md) command also includes the appliance configuration details for better troubleshooting.<!--AC-2893-->
...
There are no new deprecations announced for 1.24.1. For the list of features or components that were deprecated earlier and are planned to be removed in future releases, see {ref}`deprecation notices <ref-deprecation-notes>`.
...
See {ref}`How to upgrade Anbox Cloud <howto-upgrade-anbox-cloud>` and {ref}`How to upgrade the Anbox Cloud Appliance <howto-upgrade-appliance>` for instructions on how to update your Anbox Cloud deployment to the 1.24.1 release.
