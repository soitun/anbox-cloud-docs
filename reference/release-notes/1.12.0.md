...
AMS now supports applications declaring a port range in their manifest. This allows opening a bigger set of ports per container at once instead of having to declare each port individually.
